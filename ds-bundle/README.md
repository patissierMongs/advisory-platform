...
- **Button** — primary / dark / danger / secondary / ghost · `components/actions/Button/`

### Data Display

- **Avatar** — initials circle + identity · `components/data-display/Avatar/`
- **Badge** — tones · soft / solid / dot · `components/data-display/Badge/`
- **Chip** — removable tokens (extracted CVEs) · `components/data-display/Chip/`
- **DataTable** — grid table with badges · `components/data-display/DataTable/`
- **ProgressBar** — per-department progress · `components/data-display/ProgressBar/`
- **SeverityBadge** — critical / high / medium / low · `components/data-display/SeverityBadge/`
- **StatCard** — metric tiles · `components/data-display/StatCard/`

### Feedback

- **Alert** — info / success / warning / danger · `components/feedback/Alert/`
- **Modal** — centered overlay dialog · `components/feedback/Modal/`
- **Toast** — corner notification + confirm · `components/feedback/Toast/`

### Forms

- **Dropzone** — dashed file-drop area · `components/forms/Dropzone/`

### Layout

- **Card** — Base white surface · `components/layout/Card/`

### Navigation

- **Sidebar** — nav rail with brand + items · `components/navigation/Sidebar/`
- **Stepper** — numbered flow with connectors · `components/navigation/Stepper/`
- **Topbar** — page header with status + user · `components/navigation/Topbar/`
